...
| [`catalog-native-aliases.md`](catalog-native-aliases.md) | Additive native alias projection and provider-scoped reviewer provenance. |
...
| [`transports/astra-jev.md`](transports/astra-jev.md) | Request-local adaptive effort, public context selection, evaluator and diagnostics. |
