...
before policy capture; the opt-in [Astra-Jev policy](transports/astra-jev.md#adaptive-astra-jev-effort) uses that same native wire identity and captured adapter authority.
